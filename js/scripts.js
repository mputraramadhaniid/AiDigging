...
chatForm.addEventListener("submit", async (e) => {
  ...
  if (lowerCaseUserText === "berikan aku aplikasi cerito ke bae") {
    ...
    const downloadFileUrl = "https://example.com/CeritoKeBae.apk";
    ...
    // ... (kode untuk menambahkan tombol download) ...
  ...
  // Tampilkan pesan user di UI, posisinya masih akan di bawah jika ini pesan pertama
  ...
  try {
    ...
    const requestBody = { contents: finalContents, systemInstruction: { parts: [{ text: "You are AI Digging. A helpful and smart assistant..." }] } };
    const apiKey = "AIzaSyBe6EkfS-eVWMOQalm2TpxL6ljGBC2z9dI";
    ...
    // Hapus animasi loading dan tampilkan respons bot
    removeLoadingMessage();
    ...
    messages.push({ role: "assistant", content: botReply, files: [], id: generateUniqueId() });
    ...
    // 3. KUNCI UTAMA: Jika ini adalah pesan pertama, ubah layout ke atas SEKARANG,
    // yaitu SETELAH semua proses (termasuk respons bot) selesai.
    if (isFirstMessage) {
      chatBox.classList.add("align-top");
    }
  }
...
ument.getElementById("sidebar"); // Duplicate ID, ensure this references the correct 'sidebar' if used differently
const sidebarOverlay = document.getElementById("sidebarOverlay");
const emptyMessage = document.getElementById("emptyMessage");
const pricing = document.getElementById("pricing");
const jelajahideveloper = document.getElementById("jelajahideveloper");
